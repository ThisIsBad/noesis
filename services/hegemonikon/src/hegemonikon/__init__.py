"""Hegemonikon — interactive recorded chat surface for the Noesis AGI stack.

Hegemonikon wraps the eval harness's MCP-agent machinery to drive Claude
...
For the architectural framing of where Hegemonikon fits alongside the
existing Claude Code dev loop and the eval-harness batch surface,
see ``docs/operations/hegemonikon.md``.
"""
