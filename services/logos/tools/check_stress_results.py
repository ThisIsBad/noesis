"""Check stress benchmark answer files against expected labels."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Check stress benchmark answers")
    parser.add_argument(
        "--benchmarks",
        type=Path,
        default=Path("benchmarks/stress_test.json"),
        help="Path to stress benchmark problems JSON",
    )
    parser.add_argument(
        "--answers",
        type=Path,
        default=Path("results/llm_answers_stress.json"),
        help="Path to stress answers JSON",
    )
