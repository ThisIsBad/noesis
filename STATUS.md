...
|------|-------------|:------:|:-------:|:---:|:--:|--------:|---------:|------:|-------------|
| **empiria** | Experience accumulation and lesson extraction for the Noesis AGI stack | ✓ | ✓ | ✓ | [✓](.github/workflows/empiria.yml) | 242 | 242 | 4 | 2026-04-24 |
...
| **logos** | LLM x Deterministic Logic Verifier — exploiting the P!=NP asymmetry | ✓ | ✓ | ✓ | [✓](.github/workflows/logos.yml) | 11,873 | 10,047 | 74 | 2026-04-25 |
| **mneme** | Persistent episodic and semantic memory for the Noesis AGI stack | ✓ | ✓ | ✓ | [✓](.github/workflows/mneme.yml) | 569 | 835 | 6 | 2026-04-25 |
...
| **eval** | Reproducible benchmark harness for the Noesis AGI stack | — | — | — | [✓](.github/workflows/eval.yml) | 3,094 | 4,948 | 16 | 2026-04-25 |
| **kairos** | Cross-service observability and tracing for the Noesis AGI stack | ✓ | ✓ | ✓ | [✓](.github/workflows/kairos.yml) | 374 | 451 | 3 | 2026-04-25 |
